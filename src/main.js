...
const products = [
  {
    ...
    price: 1049.99,
    quantity: 1,
    src: "./src/assets/samsunggalaxys23ultralavender.webp",
...

  {
    ...
    price: 109.99,
    quantity: 1,
    src: "./src/assets/JBLCharge3HeroCamoX11605x1605px.webp",
  ...
  },
  {
    ...
    price: 199.99,
    quantity: 1,
    src: "./src/assets/Grayherozoom.webp",
    alt: "Beats fit pro",
  },
  {
    id: 5,
...
const divContainer = (nme, prc, qty, img, alte, id) => {
  ...
  imgStyle.src = "./src/assets/trash-svgrepo-com.svg";
